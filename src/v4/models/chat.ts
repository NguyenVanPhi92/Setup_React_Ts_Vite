...
export type MessageRes = Pick<
  IMessage,
  "room_id" | "created_at" | "product_id" | "promotion_id" | "sale_order_id"
> & {
  message_id: string
  is_author: boolean
...
export type SendMessage = Pick<
  IMessage,
  "text" | "room_id" | "product_id" | "sale_order_id" | "promotion_id"
> & {
...
export type SendMessageForm = Partial<
  Pick<SendMessage, "attachment_ids" | "product_id" | "promotion_id" | "sale_order_id" | "text">
>
