...
import { PayloadType, ShippingAddress, UserEdit, UserInfo, UserSlice } from '@/models'
...
export const { logout, setToken, setUserInfo, setAddressDefault, editUserInfo, setFCMToken, setChatToken } =
  userSlice.actions
